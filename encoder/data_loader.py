...
#         self.args = args
#         self.pro_dir = os.path.join(self.args.data_dir, 'pro_sg')
...
#         tp = pd.read_csv(os.path.join(self.args.data_dir, self.args.train_data), header=0)
...
#     # Load Data
#     raw_data = pd.read_csv(os.path.join(self.args.data_dir, self.args.train_data), header=0)
